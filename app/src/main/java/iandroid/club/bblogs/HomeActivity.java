...
import com.iandroid.bbase_module.router.FragmentUtils;
...
public class HomeActivity extends AppCompatActivity {
    ...
    private int[] tabIcons = {
            R.mipmap.tab_scan_enabled,
            R.mipmap.tab_products_enabled,
            R.mipmap.tab_stores_enabled,
            R.mipmap.tab_profile_enabled
    };
